...
@section('title', 'เพิ่มแพสินค้าใหม่')

@section('content_header')
    <div class="row">
        <div class="col-sm-6">
            <h1>เพิ่มแพสินค้าใหม่</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">หน้าหลัก</a></li>
                <li class="breadcrumb-item"><a href="{{ route('admin.packages.index') }}">แพสินค้า</a></li>
                <li class="breadcrumb-item active">เพิ่มแพใหม่</li>
            </ol>
        </div>
    </div>
@stop
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="3" 
                                      placeholder="คำอธิบายเกี่ยวกับแพ">{{ old('description') }}</textarea>
                            @error('description')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('length_unit') is-invalid @enderror" 
                                    ...
                                    name="length_unit" 
                                    required>
                                <option value="เมตร" {{ old('length_unit') === 'เมตร' ? 'selected' : '' }}>เมตร</option>
                                <option value="เซนติเมตร" {{ old('length_unit') === 'เซนติเมตร' ? 'selected' : '' }}>เซนติเมตร</option>
                                <option value="กิโลเมตร" {{ old('length_unit') === 'กิโลเมตร' ? 'selected' : '' }}>กิโลเมตร</option>
                            </select>
                            @error('length_unit')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('item_unit') is-invalid @enderror" 
                                    ...
                                    name="item_unit" 
                                    required>
                                <option value="ต้น" {{ old('item_unit') === 'ต้น' ? 'selected' : '' }}>ต้น</option>
                                <option value="ชิ้น" {{ old('item_unit') === 'ชิ้น' ? 'selected' : '' }}>ชิ้น</option>
                                <option value="อัน" {{ old('item_unit') === 'อัน' ? 'selected' : '' }}>อัน</option>
                                <option value="ท่อน" {{ old('item_unit') === 'ท่อน' ? 'selected' : '' }}>ท่อน</option>
                            </select>
                            @error('item_unit')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('weight_unit') is-invalid @enderror" 
                                    id="weight_unit" 
                                    name="weight_unit">
                                <option value="กิโลกรัม" {{ old('weight_unit') === 'กิโลกรัม' ? 'selected' : '' }}>กิโลกรัม</option>
                                <option value="กรัม" {{ old('weight_unit') === 'กรัม' ? 'selected' : '' }}>กรัม</option>
                                <option value="ตัน" {{ old('weight_unit') === 'ตัน' ? 'selected' : '' }}>ตัน</option>
                            </select>
                            @error('weight_unit')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
...
@section('js')
    ...
    <script>
        ...
        function updateProductInfo(index) {
            ...
            const unitDisplay = document.querySelector(`input[name="products[${index}][unit]"]`);
