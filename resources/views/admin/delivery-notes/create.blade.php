...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1><i class="fas fa-plus-circle text-success"></i> สร้างใบตัดสต็อก</h1>
        </div>
        <div class="col-sm-6">
                    ...
                    <div class="card-body pb-1">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('customer_name') is-invalid @enderror"
                                   name="customer_name" value="{{ old('customer_name') }}" placeholder="ชื่อลูกค้า / บริษัท" required autofocus>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('customer_phone') is-invalid @enderror"
                                           name="customer_phone" value="{{ old('customer_phone') }}" placeholder="08x-xxx-xxxx">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('sales_order_number') is-invalid @enderror"
                                           name="sales_order_number" value="{{ old('sales_order_number') }}" placeholder="SO-XXX">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('quotation_number') is-invalid @enderror"
                                           name="quotation_number" value="{{ old('quotation_number') }}" placeholder="QT-XXX">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror"
                                      name="notes" rows="2" placeholder="หมายเหตุเพิ่มเติม (ถ้ามี)">{{ old('notes') }}</textarea>
...
function initSelect2(selectEl) {
    $(selectEl).select2({
        ...
        matcher: function(params, data) {
            // ค้นหาจาก ชื่อ, SKU, barcode, หมวดหมู่
            ...
            <div class="row align-items-center">
                ...
                <div class="col-5 col-md-2">
                    <input type="number" class="form-control form-control-sm text-center qty-input"
                           name="items[${idx}][quantity]" value="1" min="1" placeholder="จำนวน" required
                           id="qty-${idx}">
                </div>
                <div class="col-5 col-md-3">
                    <input type="text" class="form-control form-control-sm"
                           name="items[${idx}][notes]" placeholder="หมายเหตุ">
                </div>
...
function removeItem(idx) {
    ...
    if (el) {
        // Destroy Select2 ก่อนลบ element
