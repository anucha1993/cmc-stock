                            ...
                            <div class="col-md-8">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    @error('barcode')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                    <small class="text-muted">บาร์โค้ดห้ามเปลี่ยน เพราะอาจเชื่อมโยงกับระบบอื่น</small>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    @error('thickness')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                    <small class="text-muted">เดิม: {{ $product->thickness ? number_format($product->thickness, 2) : 'ไม่ระบุ' }} มิล</small>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    @error('steel_type')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                    <small class="text-muted">เดิม: {{ $product->steel_type_text }}</small>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    @error('side_steel_type')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                    <small class="text-muted">เดิม: {{ $product->side_steel_type_text }}</small>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    @error('measurement_unit')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                    <small class="text-muted">เดิม: {{ $product->measurement_unit_text }}</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    @error('size_type')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                    <small class="text-muted">เดิม: {{ $product->size_type_text }}</small>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div id="custom_size_options_container" style="{{ old('size_type', $product->size_type) == 'custom' ? '' : 'display: none;' }}">
                                            <div class="form-group">
...
}'>{{ old('custom_size_options', is_array($product->custom_size_options) ? json_encode($product->custom_size_options, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) : $product->custom_size_options) }}</textarea>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    @error('min_stock_quantity')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                    <small class="text-muted">เดิม: {{ $product->min_stock }} แจ้งเตือนเมื่อสต็อกต่ำกว่านี้</small>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    @error('max_stock_quantity')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                    <small class="text-muted">เดิม: {{ $product->max_stock }} จำนวนสต็อกสูงสุดที่เก็บได้</small>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    @error('location')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                    <small class="text-muted">เดิม: {{ $product->location ?: 'ไม่ระบุ' }} - ระบุตำแหน่งจัดเก็บในคลังสินค้า</small>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-plaintext" id="size_display">
                                                        <span class="text-info">{{ $product->length && $product->thickness ? number_format($product->length, 0).'x'.number_format($product->thickness, 0).' '.$product->measurement_unit_short : ($product->length ? number_format($product->length, 2).' '.$product->measurement_unit_short : '-') }}</span>
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if($product->main_image)
                                                <div class="mt-3">
                                                    ...
                                                    <div>
                                                        <img src="{{ $product->main_image }}" alt="{{ $product->name }}" class="img-thumbnail" style="max-width: 200px;">
                                                    </div>
                                                </div>
                                            @endif
                                            ...
                                            <div class="card-body">
                                                <div id="productPreview">
                                                    ...
                                                    <p id="previewSupplier" class="mb-1">
                                                        <small class="text-muted">ผู้จำหน่าย: <span id="supplierName">{{ $product->supplier->name ?? '-' }}</span></small>
                                                    </p>
                                                    <p id="previewSize" class="mb-1">
                                                        <small><span id="sizeInfo">{{ $product->length && $product->thickness ? number_format($product->length, 0).'x'.number_format($product->thickness, 0).' '.$product->measurement_unit_short : ($product->length ? number_format($product->length, 2).' '.$product->measurement_unit_short : '-') }}</span></small>
                                                    </p>
                                                    <p id="previewStock" class="mb-0">
                                                        <span class="badge badge-{{ $product->stock_status_color }}">สต็อก: <span id="stockInfo">{{ $product->total_stock }}</span></span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
...
@section('js')
    <script>
        $(document).ready(function() {
            // Update preview
            $('#name, #category_id, #supplier_id, #length, #thickness, #measurement_unit').on('input change', function() {
                updatePreview();
                updateSizeDisplay();
            });
        ...
        function updatePreview() {
            ...
            var supplierText = $('#supplier_id option:selected').text() || '{{ $product->supplier->name ?? "-" }}';
